...
SECRET_KEY = '46$4y1#e^8wo*)xl)4ccq#7=f)wc*3_y12rr16tx$&ffg!)&^8'
...
AUTH_USER_MODEL = 'auth.User' # instagram 앱 안에 User 모델을 만들었다면 instagram.User 지정, default 값은 auth.User